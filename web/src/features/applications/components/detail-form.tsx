...
import type { Application, ApplicationStatus, TagSummary } from "../model";
...
export function DetailForm({ application, availableTags, isSaving, onSubmit }: DetailFormProps) {
  ...
  return (
    ...
    >
      ...
      <select {...register("status")} className="w-full rounded-md border border-[var(--border)] bg-transparent px-3 py-2 text-sm">
